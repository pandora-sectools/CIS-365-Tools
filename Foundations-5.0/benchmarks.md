...
3 Microsoft Purview
    ...
    3.3 Information Protection
            3.3.1      (L1)    (Manual)       Ensure Information Protection sensitivity label policies are published
...
5 Microsoft Entra admin center
    ...
    5.1 Identity
        ...
        5.1.8 Hybrid management
            5.1.8.1    (L1)    (Manual)       Ensure that password hash sync is enabled for hybrid deployments                                              (TODO) 


    5.2 Protection

        5.2.2 Conditional Access
            5.2.2.1    (L1)    (Automated)    Ensure multifactor authentication is enabled for all users in administrative roles                            (TODO) 
            5.2.2.2    (L1)    (Automated)    Ensure multifactor authentication is enabled for all users                                                    (TODO) 
            5.2.2.3    (L1)    (Automated)    Enable Conditional Access policies to block legacy authentication                                             (TODO) 
            5.2.2.4    (L1)    (Automated)    Ensure Sign-in frequency is enabled and browser sessions are not persistent for Administrative users          (TODO) 
            5.2.2.5    (L2)    (Automated)    Ensure 'Phishing-resistant MFA strength' is required for Administrators                                       (TODO) 
            5.2.2.6    (L1)    (Automated)    Enable Identity Protection user risk policies                                                                 (TODO) 
            5.2.2.7    (L1)    (Automated)    Enable Identity Protection sign-in risk policies                                                              (TODO) 
            5.2.2.8    (L2)    (Automated)    Ensure 'sign-in risk' is blocked for medium and high risk                                                     (TODO) 
            5.2.2.9    (L1)    (Automated)    Ensure a managed device is required for authentication                                                        (TODO) 
            5.2.2.10   (L1)    (Automated)    Ensure a managed device is required to register security information                                          (TODO) 
            5.2.2.11   (L1)    (Automated)    Ensure sign-in frequency for Intune Enrollment is set to 'Every time'                                         (TODO) 
            5.2.2.12   (L1)    (Automated)    Ensure the device code sign-in flow is blocked                                                                (TODO) 
        ...
        5.2.3 Authentication Methods
            ...
            5.2.3.6    (L1)    (Manual)       Ensure system-preferred multifactor authentication is enabled                                                 (TODO) 
    ...
    5.3 Identity Governance
            5.3.1      (L2)    (Automated)    Ensure 'Privileged Identity Management' is used to manage roles                                               (TODO) 
            ...
            5.3.4      (L1)    (Manual)       Ensure approval is required for Global Administrator role activation                                          (TODO) 
            5.3.5      (L1)    (Manual)       Ensure approval is required for Privileged Role Administrator activation                                      (TODO) 
