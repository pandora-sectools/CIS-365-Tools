...
1 Microsoft 365 admin center
    ...
    1.2 Teams & groups
        1.2.1  (L2) Ensure that only organizationally managed/approved public groups exist (Automated)                                             (TODO)
        1.2.2  (L1) Ensure sign-in to shared mailboxes is blocked (Automated)                                                                      (TODO)

    1.3 Settings
        1.3.1  (L1) Ensure the 'Password expiration policy' is set to 'Set passwords to never expire (recommended)' (Automated)                    (TODO)
        1.3.2  (L2) Ensure 'Idle session timeout' is set to '3 hours (or less)' for unmanaged devices (Automated)                                  (TODO)
        1.3.3  (L2) Ensure 'External sharing' of calendars is not available (Automated)                                                            (TODO)
        1.3.4  (L1) Ensure 'User owned apps and services' is restricted (Automated)                                                                (TODO)
        1.3.5  (L1) Ensure internal phishing protection for Forms is enabled (Automated)                                                           (TODO)
        1.3.6  (L2) Ensure the customer lockbox feature is enabled (Automated)                                                                     (TODO)
        1.3.7  (L2) Ensure 'third-party storage services' are restricted in 'Microsoft 365 on the web' (Automated)                                 (TODO)
...
2 Microsoft 365 Defender
    ...
    2.1 Email & collaboration
        2.1.1  (L2) Ensure Safe Links for Office Applications is Enabled (Automated)                                                               (TODO)
        2.1.2  (L1) Ensure the Common Attachment Types Filter is enabled (Automated)                                                               (TODO)
        2.1.3  (L1) Ensure notifications for internal users sending malware is Enabled (Automated)                                                 (TODO)
        2.1.4  (L2) Ensure Safe Attachments policy is enabled (Automated)                                                                          (TODO)
        2.1.5  (L2) Ensure Safe Attachments for SharePoint, OneDrive, and Microsoft Teams is Enabled (Automated)                                   (TODO)
        2.1.6  (L1) Ensure Exchange Online Spam Policies are set to notify administrators (Automated)                                              (TODO)
        2.1.7  (L2) Ensure that an anti-phishing policy has been created (Automated)                                                               (TODO)
        2.1.8  (L1) Ensure that SPF records are published for all Exchange Domains (Automated)                                                     (TODO)
        2.1.9  (L1) Ensure that DKIM is enabled for all Exchange Online Domains (Automated)                                                        (TODO)
        2.1.10 (L1) Ensure DMARC Records for all Exchange Online domains are published (Automated)                                                 (TODO)
        2.1.11 (L2) Ensure comprehensive attachment filtering is applied (Automated)                                                               (TODO)
        2.1.12 (L1) Ensure the connection filter IP allow list is not used (Automated)                                                             (TODO)
        2.1.13 (L1) Ensure the connection filter safe list is off (Automated)                                                                      (TODO)
        2.1.14 (L1) Ensure inbound anti-spam policies do not contain allowed domains (Automated)                                                   (TODO)
    ...
    2.4 System
        2.4.1  (L1) Ensure Priority account protection is enabled and configured (Automated)                                                       (TODO)
        2.4.2  (L1) Ensure Priority accounts have 'Strict protection' presets applied (Automated)                                                  (TODO)
        2.4.3  (L2) Ensure Microsoft Defender for Cloud Apps is enabled and configured (Manual)                                                    (TODO)
        2.4.4  (L1) Ensure Zero-hour auto purge for Microsoft Teams is on (Automated)                                                              (TODO)
...
3 Microsoft Purview
    3.1 Audit
        3.1.1  (L1) Ensure Microsoft 365 audit log search is Enabled (Automated)                                                                   (TODO)
    3.2 Data loss protection
        3.2.1  (L1) Ensure DLP policies are enabled (Manual)                                                                                       (TODO)
        3.2.2  (L1) Ensure DLP policies are enabled for Microsoft Teams (Automated)                                                                (TODO)
    3.3 Information Protection
        3.3.1  (L1) Ensure Information Protection sensitivity label policies are published (Manual)                                                (TODO)




4 Microsoft Intune admin center
    4.1  (L2) Ensure devices without a compliance policy are marked 'not compliant' (Automated)                                                    (TODO)
    4.2  (L2) Ensure device enrollment for personally owned devices is blocked by default (Manual)                                                 (TODO)
...
5 Microsoft Entra admin center
    ...
    5.1 Identity
        ...
        5.1.2 Users
            ...
            5.1.2.2  (L2) Ensure third party integrated applications are not allowed (Automated)                                                   (TODO)
            5.1.2.3  (L1) Ensure 'Restrict non-admin users from creating tenants' is set to 'Yes' (Automated)                                      (TODO)
        ...
        5.1.3 Groups
            5.1.3.1  (L1) Ensure a dynamic group for guest users is created (Automated)                                                            (TODO)
        ...
        5.1.6 External Identities
            ...
            5.1.6.3  (L2) Ensure guest user invitations are limited to the Guest Inviter role (Automated) . 196(TODO)
...
8 Microsoft Teams admin center                                                                                                                    (TODO)
    8.1 Teams                                                                                                                                     (TODO)
        8.1.1  (L2) Ensure external file sharing in Teams is enabled for only approved cloud storage services (Automated)                         (TODO)
        8.1.2  (L1) Ensure users can't send emails to a channel email address (Automated)                                                         (TODO)

    8.2 Users                                                                                                                                     (TODO)
        8.2.1  (L2) Ensure external domains are restricted in the Teams admin center (Automated) . 374(TODO)
    ...
    8.6 Messaging
        8.6.1  (L1) Ensure users can report security concerns in Teams (Automated)                                                                (TODO)
...
9 Microsoft Fabric
    9.1 Tenant settings
        9.1.1  (L1) Ensure guest user access is restricted (Manual)                                                                               (TODO)
