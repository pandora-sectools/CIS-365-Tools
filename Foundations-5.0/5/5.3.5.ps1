...
try {
    ...
    Write-Host "** ERROR : Unable to retrieve the Privileged Role Administrator role management policy assignment. **"
...
try {
    ...
    Write-Host "** ERROR : Unable to retrieve the Privileged Role Administrator approval rule. **"
    Write-Host $ErrorText
    return
}
